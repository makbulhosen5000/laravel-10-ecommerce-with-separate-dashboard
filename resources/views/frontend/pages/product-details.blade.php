                ...
                <div class="left-side xl:w-7/12 w-full">
                    <div class="gallery-container mb-[50px]">
                                            ...
                                            @if ($gallery->images)
                                                ...
                                                @foreach ($images as $image)
                                                    <div class="swiper-slide">
                                                        <img src="{{ asset('public/storage/uploads/' . $image) }}"
                                                            alt="Gallery Image">
                                                    </div>
                                                @endforeach
                                            @endif
                        ...
                        <div class="single-product-desc">
                            ...
                            <p class="text-[#636270] text-base mb-3">{{ }}</p>


                        </div>
                    </div>
                <div class="right-side xl:px-8 px-0 xl:w-5/12 w-full">
                    <h2 class="text-[#272343] pro-title font-semibold mb-3 capitalize">isolate sofa Chair</h2>
                    <div class="flex items-center gap-2.5 mb-6">
                        <p class="flex gap-1.5 items-center">
                            <span class="text-[#272343] text-2xl">$250</span>
                    ...
                    <p class="text-[#636270] text-base mb-6">
                        As you run your fingers across the surface of this golden oak colored vanity set, you’ll understand
                        why it stands out from the rest; from the table to the legs.
                    </p>
                    <div class="mb-6">
                    ...
                    <div class="single-product-desc2">
                        <h2 class="text-[#272343] text-2xl font-semibold mb-3.5">Product Descriptions</h2>
                        <p class="text-[#636270] text-base mb-3">Super Stretchy form fit fabric: This super stretchable
                            sofa slipcover will ensure your three-seater sofa is completely covered. Our slipcovers are
                            designed and ready-made to fit a variety of sofa sizes, stretches to 66” with seat width up to
                            90”</p>

                        <p class="text-[#636270] text-base mb-3">Transform your old sofa or protect your new one: PureFit
                            sofa furniture protectors not only protects your sofa furniture daily wears and tears, kids,
                            scratches from pets, dogs or accidental spills, it also transforms an old, worn out couch into
                            the stunning centerpiece of your room</p>

                        <p class="text-[#636270] text-base mb-3">The sofa cover that stays in place: Featuring non skid
                            elastic bottom and premium non slip foam anchors, our sofa furniture slipcovers are among the
                            only ones in the market to guarantee they will stay tight with no snag, no wrinkling, shifting
                            or slipping even after sitting or taking a nap on it</p>

                        <p class="text-[#636270] text-base mb-3">Easy to install/put on: You'll be done in no time! Just
                            slip it on, Tuck any extra fabric and insert the non slip foam anchors into the gap/crease
                            between the back and sitting cushions for a seamless look and VOILA! Use our picture guidelines
                            to ensure a good fit (Installation Instructions Included)</p>

                        <p class="text-[#636270] text-base">Easy care & 6 month warranty: Machine Washable Slipcover, wash
